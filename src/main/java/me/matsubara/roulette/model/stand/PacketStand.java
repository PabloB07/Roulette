    ...
    static {
        ...
        if (XReflection.supports(18)) {
            ...
            if (XReflection.supports(21, 4)) {
                ...
                DWO_CUSTOM_NAME_VISIBLE = Reflection.getStaticFieldValue(ENTITY, "aP");
                DWO_ARMOR_STAND_DATA = Reflection.getStaticFieldValue(ENTITY_ARMOR_STAND, "bJ");
                DWO_HEAD_POSE = Reflection.getStaticFieldValue(ENTITY_ARMOR_STAND, "bK");
                DWO_BODY_POSE = Reflection.getStaticFieldValue(ENTITY_ARMOR_STAND, "bL");
                DWO_LEFT_ARM_POSE = Reflection.getStaticFieldValue(ENTITY_ARMOR_STAND, "bM");
                DWO_RIGHT_ARM_POSE = Reflection.getStaticFieldValue(ENTITY_ARMOR_STAND, "bN");
                DWO_LEFT_LEG_POSE = Reflection.getStaticFieldValue(ENTITY_ARMOR_STAND, "bO");
                DWO_RIGHT_LEG_POSE = Reflection.getStaticFieldValue(ENTITY_ARMOR_STAND, "bP");
                DWO_SCALE_ID = Reflection.getStaticFieldValue(ENTITY_DISPLAY, "t");
                DWO_TEXT_ID = Reflection.getStaticFieldValue(ENTITY_TEXT_DISPLAY, "aG");
                DWO_BACKGROUND_COLOR_ID = Reflection.getStaticFieldValue(ENTITY_TEXT_DISPLAY, "aI");
